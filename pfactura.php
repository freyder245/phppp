<!DOCTYPE html>
<html lang="es">
<head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Sistema Vacunación</title> <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet"> <style> /* Añadir estilo para la imagen de fondo */ body { background-image: url('https://media.realinstitutoelcano.org/wp-content/uploads/2021/10/ari15-2021-vilasanjuan-covid-19-geopolitica-de-la-vacuna.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; background-attachment: fixed; } </style>
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-100">
    ...
    <nav class="fixed top-0 left-0 w-full bg-green-600 p-4 shadow-md z-10">
    <div class="max-w-6xl mx-auto flex justify-between items-center">
        <!-- Logo o título -->
        <a href="#" class="text-white text-2xl font-bold">IPS</a>
        <ul class="flex space-x-6">
            <!-- Opción Facturas -->
            <li>
                <a href="pfactura.php" class="text-white border border-white hover:bg-green-500 px-3 py-2 rounded-md text-lg font-semibold">Facturas</a>
            </li>
            <!-- Opción Productos -->
            <li>
                <a href="producto.html" class="text-white border border-white hover:bg-green-500 px-3 py-2 rounded-md text-lg font-semibold">Productos</a>
            </li>
            <!-- Opción Cliente (Principal) -->
            <li>
                <a href="htmlCRUD.html" class="text-white border border-white hover:bg-green-500 px-3 py-2 rounded-md text-lg font-semibold">Cliente</a>
            </li>
        </ul>
    </div>
</nav>
